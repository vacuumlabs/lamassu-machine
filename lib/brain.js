...
var Brain = function(config) {
  ...
  var billValidatorLib = config.id003.deviceType === 'cashflowSc' ?
    './mei/cashflow_sc' :
    './id003/id003';
  this.billValidator = require(billValidatorLib).factory(config.id003);
...
Brain.prototype._pollUpdate = function _pollUpdate() {
  ...
  this.billValidator.currency = this.currency;
